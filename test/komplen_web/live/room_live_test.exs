defmodule KomplenWeb.RoomLiveTest do
  use KomplenWeb.ConnCase

  import Phoenix.LiveViewTest
  import Komplen.ChatFixtures

  @create_attrs %{room_id: "7488a646-e31f-11e4-aace-600308960662"}
  @update_attrs %{room_id: "7488a646-e31f-11e4-aace-600308960668"}

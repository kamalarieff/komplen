defmodule Komplen.ChatTest do
  ...
  describe "rooms" do
    ...
    test "create_room/1 with valid data creates a room" do
      valid_attrs = %{room_id: "7488a646-e31f-11e4-aace-600308960662"}

      assert {:ok, %Room{} = room} = Chat.create_room(valid_attrs)
      assert room.room_id == "7488a646-e31f-11e4-aace-600308960662"
    end
    ...
    test "update_room/2 with valid data updates the room" do
      ...
      assert room.room_id == "7488a646-e31f-11e4-aace-600308960668"
    end
